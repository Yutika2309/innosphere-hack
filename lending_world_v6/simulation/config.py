...
class SimulationConfig:
    ...
    runs_root_dir: str = "runs"
    scenario_output_mode: str = "separate_directories"
    baseline_scenario_name: str = "baseline"
    improved_scenario_name: str = "improved"
    current_scenario_name: str = "baseline"
    run_id_strategy: str = "timestamp"
    run_id: Optional[str] = None
    write_run_metadata: bool = True
    write_latest_run_pointer: bool = True
    allow_resume_from_latest_run: bool = True
    summary_uses_persisted_outputs: bool = True
...
def _validate_config_values(values: Dict[str, Any]) -> Dict[str, Any]:
    ...
    allowed_scenarios = {
        str(values.get("baseline_scenario_name", "baseline")),
        str(values.get("improved_scenario_name", "improved")),
    }
    if str(values.get("current_scenario_name", "baseline")) not in allowed_scenarios:
        values["current_scenario_name"] = values.get("baseline_scenario_name", "baseline")
    return values
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--runs-root-dir", dest="runs_root_dir", type=str, default=None)
    parser.add_argument("--current-scenario-name", dest="current_scenario_name", type=str, default=None)
    parser.add_argument("--run-id", dest="run_id", type=str, default=None)
    parser.add_argument("--scenario-output-mode", dest="scenario_output_mode", type=str, default=None)
    parser.add_argument("--allow-resume-from-latest-run", dest="allow_resume_from_latest_run", type=_as_bool, default=None)
    return parser
