...
def build_run_summary_from_dir(run_dir):
    """Build a restart-safe run summary from persisted CSV outputs."""
    try:
        from .run_summary import summarise_run_dir
    except Exception:  # pragma: no cover
        from run_summary import summarise_run_dir  # type: ignore
