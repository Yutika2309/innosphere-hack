...
MARKETPLACE_DASHBOARD_COLUMNS = [
    ...
    "dashboard_timestep",
    "public_offer_count",
    "active_public_offer_count",
    "offer_cap_applied",
    "max_active_public_offers",
    "max_active_public_offers_per_bank",
    "offers_suppressed_by_cap",
...
CONVERSION_METRICS_COLUMNS = [
    ...
    "deutsche_bank_selected_customers_delta",
    "deutsche_bank_selected_customer_ids",
    "deutsche_bank_acquired_customers",
    "deutsche_bank_acquired_customers_delta",
    "deutsche_bank_acquired_customer_ids",
